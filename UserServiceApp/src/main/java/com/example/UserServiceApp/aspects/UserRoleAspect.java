...
import com.example.UserServiceApp.exceptions.ForbiddenException;
...
public class UserRoleAspect {
    ...
    @Before("@annotation(userRoleCheck) && execution(* com.example.UserServiceApp.controller.*.*(..))  && args(.., credentials)")
