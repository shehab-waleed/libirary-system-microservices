package com.example.UserServiceApp.aspects;


import com.example.UserServiceApp.enums.UserRole;
import com.example.UserServiceApp.exceptions.UnauthorizedException;
...
public class AuthorizationAspect {
    ...
    @Before(value = "@annotation(com.example.UserServiceApp.annotations.AuthorizationRequired) && execution(* com.example.UserServiceApp.controller.*.*(..)) && args(.., credentials)")
